...
$.widget('custom.mcautocomplete', $.ui.autocomplete, {
    _renderMenu: function (ul, items) {
        ...
        if (this.options.showHeader) {
            table = $('<div class="ui-widget-header" style="width:100%;height:30px !important"></div>');
            tableCabecera = $('<table style="width:97%;border-collapse: collapse;height:25px;"></table>');
            trCabecera = $('<tr></tr>');
